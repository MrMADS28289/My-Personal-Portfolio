        ...
        <section
            ...
            <div className='about-dec text-gray-300'>
                <div className='about-slide-container'>
                    ...
                    <p className='text-gray-400 about-slide-p'>Hello, my name is Masum Abduss Sobhan, and I am a 19-year-old MERN stack developer. I have a passion for web development and have been honing my skills in the field for a while now. I discovered the power of the MERN stack (MongoDB, Express.js, React.js, and Node.js) and knew that this was the path I wanted to pursue. I am skilled in creating innovative and interactive web applications using this stack. I am particularly adept at creating responsive and dynamic user interfaces using React.js, and I have experience working with MongoDB, a popular NoSQL database. I am comfortable with both SQL and NoSQL databases. </p>
                </div>

                <p className='text-gray-400 my-6'>I am a hardworking and dedicated developer who is always looking to improve my skills and stay up-to-date with the latest technologies. I am a quick learner and am always willing to take on new challenges. In addition to web development, I am also interested in other areas of computer science such as machine learning and artificial intelligence. I am excited to see where my passion for web development will take me in the future.</p>
